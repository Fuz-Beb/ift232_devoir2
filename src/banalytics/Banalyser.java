...
/*
 * Classe qui sert � journaliser les �v�nements qui surviennent durant l'utilisation d'un contenu
 * multim�dia par un utilisateur. Une fois les �v�nements correctement journalis�s, il deviendra
